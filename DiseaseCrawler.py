...
#     if key == 'Entry':
#         value = each_tr.xpath('string(./td/table/tr/td[1]/code/nobr)').strip()
#
#     elif key == 'Brite':
#         value = each_tr.xpath('string(./td/div/nobr)').strip() + '\n'
#         for each_link in each_tr.xpath('./td/div/nobr/a'):
#             value += "https://www.kegg.jp" + each_link.xpath('./@href')[0] + '\n'
#
#     elif key == 'Gene':
#         value = each_tr.xpath('string(./td/div)').strip() + '\n'
...
#
#     elif key == 'LinkDB':
#         value = "https://www.genome.jp/dbget-bin/get_linkdb?disease+"
#
#     else:
#         value = each_tr.xpath('string(./td/div)').strip()
#
